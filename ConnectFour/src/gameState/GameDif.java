...
public class GameDif extends State {
	...
	public GameDif() {
		easy = new GameButton(225 - 160, 200, 150, 50, new Color(250, 0, 0), new Color(200, 0, 0), "Easy",
				new Set(EASY), true);
		med = new GameButton(225, 200, 150, 50, new Color(250, 0, 0), new Color(200, 0, 0), "Medium", new Set(MED),
				true);
		hard = new GameButton(225 + 160, 200, 150, 50, new Color(250, 0, 0), new Color(200, 0, 0), "Hard",
				new Set(HARD), true);
	}
