...
public class GameButton {
	...
	public GameButton(int x, int y, int width, int height, Color base, Color hover, String text, gameAction event,
			boolean boarder) {
	...
	public void tick(int mx, int my) {
		...
		if (bounded && MouseInput.released(1))// if it is clicked and inbounds and its the first time clicked it will
												// run the event
